        ...
        children: <Widget>[
          ...
          Container(
              ...
              child: GridView.count(
                ...
                children: <Widget>[
                  _buildCard('T-shirt', '\1 Hour', 'assets/shirt.jpg',
                      false, false, context),
                  _buildCard('Shose', '\30 minutes', 'assets/shose.jpg',
                      false, false, context),
                  _buildCard('Pejama', '\4 hours',
                      'assets/pejama.jpg', false, true, context),
                  _buildCard('Hat', '\Now', 'assets/hot.jpg',
                      false, false, context)
                ],
              )),
          SizedBox(height: 15.0)
        ...
        child: InkWell(
            onTap: () {
              Navigator.of(context).push(
                  MaterialPageRoute(builder: (context) => Clothesv(
                    assetPath: imgPath,
                    cookiename: name,
                    cookieprice:price
                  )));
